function KeyboardInputManager() {
  ...
  function () {
    for (var e = 0, t = [
      'webkit',
      'moz'
    ], i = 0; i < t.length && !window.requestAnimationFrame; ++i) window.requestAnimationFrame = window[t[i] + 'RequestAnimationFrame'],
  ...
  HTMLActuator.prototype.addTile = function (e) {
    ...
    e.value > 2048 && r.push('tile-super'),
    this.applyClasses(i, r),
    ...
    e.previousPosition ? window.requestAnimationFrame((function () {
      ...
      t.addTile(e)
    })))  : (r.push('tile-new'), this.applyClasses(i, r)),
    i.appendChild(o),
  ...
  Grid.prototype.empty = function () {
    for (var e = [
    ], t = 0; t < this.size; t++) for (var i = e[t] = [
    ], o = 0; o < this.size; o++) i.push(null);
    return e
  },
  Grid.prototype.fromState = function (e) {
    for (var t = [
    ], i = 0; i < this.size; i++) for (var o = t[i] = [
    ], n = 0; n < this.size; n++) {
      var a = e[i][n];
  ...
  Grid.prototype.eachCell = function (e) {
    for (var t = 0; t < this.size; t++) for (var i = 0; i < this.size; i++) e(t, i, this.cells[t][i])
  },
  ...
  Grid.prototype.serialize = function () {
    ...
    ], o = 0; o < this.size; o++) i.push(this.cells[t][o] ? this.cells[t][o].serialize()  : null);
    return {
      size: this.size,
      cells: e
    }
  ...
  GameManager.prototype.setup = function () {
    ...
    e ? (this.grid = new Grid(e.grid.size, e.grid.cells), this.score = e.score, this.over = e.over, this.won = e.won, this.keepPlaying = e.keepPlaying)  : (this.grid = new Grid(this.size), this.score = 0, this.over = !1, this.won = !1, this.keepPlaying = !1, this.addStartTiles()),
    this.actuate()
  },
  ...
  GameManager.prototype.addRandomTile = function () {
    if (this.grid.cellsAvailable()) {
      var e = Math.random() < 0.9 ? 0.5 : 0.25,
        ...
        a.y.forEach((function (a) {
          if (i = {
            ...
            if (c && c.value === o.value && !c.mergedFrom) {
              var l = new Tile(s.next, 0.5 * o.value);
              l.mergedFrom = [
                o,
                c
              ],
  ...
  GameManager.prototype.tileMatchesAvailable = function () {
    for (var e, t = 0; t < this.size; t++) for (var i = 0; i < this.size; i++) if (e = this.grid.cellContent({
      x: t,
      y: i
    })) for (var o = 0; o < 4; o++) {
